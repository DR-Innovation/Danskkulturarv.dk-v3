...
// Will throw Notice: Constant WP_DEBUG already defined
...
function lumturio_system_report($return_json = false) {
    ...
    global $wp_version;
    $res = array("php_version" => phpversion(), "engine" => "WORDPRESS", "wordpress_version" => $wp_version, "data" => $all_plugins, "status_message" => lumturio_get_update_message(), "last_checked" => lumturio_get_update_data_last_checked());
...
function lumturio_settings_page() { ?>
    ...
    <form method="post" action="options.php">
        ...
        <table>
            ...
            <tbody>
            <?php $report = lumturio_system_report(); foreach($report['data'] as $plugin) { ?>
            <tr>
