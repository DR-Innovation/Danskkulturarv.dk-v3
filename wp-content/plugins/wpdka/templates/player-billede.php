...
?>
		<li>
			...
			<?php endif; ?>
				<img src="<?php echo WPChaosClient::get_object()->organization == 'SMK' ? WPDKAObject::resizeImage(htmlspecialchars($file->URL)) : htmlspecialchars($file->URL); ?>" alt="<?php bloginfo('name'); ?>">
			<?php if ($link) { echo '</a>'; } ?>
		</li>
<?php ;endforeach; ?>
	</ul>
